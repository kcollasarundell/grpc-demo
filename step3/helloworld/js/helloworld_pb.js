...
proto.helloworld.HelloRequest.toObject = function(includeInstance, msg) {
  var obj = {
    ...
    betterColour: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
...
/**
 * optional string better_colour = 3;
 * @return {string}
 */
proto.helloworld.HelloRequest.prototype.getBetterColour = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.helloworld.HelloRequest.prototype.setBetterColour = function(value) {
...
proto.helloworld.HelloReply.toObject = function(includeInstance, msg) {
  var obj = {
    ...
    authed: jspb.Message.getFieldWithDefault(msg, 2, false)
  };
...
/**
 * optional bool authed = 2;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.helloworld.HelloReply.prototype.getAuthed = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 2, false));
};


/** @param {boolean} value */
proto.helloworld.HelloReply.prototype.setAuthed = function(value) {
